...
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = 'mariadb+mariadbconnector://test:test@mariadb:3306/test'
...
class Mediciones(db.Model):
    ...
    tsMedicion = db.Column('tsMedicion', db.DateTime(
...
def get_data():
    ...
    json_meds = {}
    for med in meds:
        json_meds[med.idMedicion] = ({"valor": med.valor}, {
                                     "fecha": med.tsMedicion.date()})
